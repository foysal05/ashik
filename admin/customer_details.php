                                            ...
                                            <div class="content" style="margin-top: 10px;">
                                                <div class="author">
                                                    ...
                                                    <table class="table table-hover table-striped">
                                                        <head style="font-size: 2em">Booking History</head>
                                                        <tr>
...
$query1="SELECT date,movie_name FROM booking,movie where booking.movie=movie.mid and cid='".$_GET['id']."'";
            // echo $query1;
             $result1=mysqli_query($con,$query1);
//echo mysqli_error();
             if(mysqli_num_rows($result1)>0){

              while($booking=mysqli_fetch_array($result1, MYSQLI_ASSOC)){
                echo "<tr>";
            ...
            echo "<tr>";
                 echo "<td colspan='2'>Booking Not Found !</td>";
