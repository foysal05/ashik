        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="header">
                  <h4 class="title">Hall Wise Information</h4>
                </div>
                <div class="content">
                ...
                if (isset($_GET['update'])) {
                  ...
                  ?>
                  <button type="submit" name="get" class="btn btn-info btn-fill pull-right">Get List</button>
                  <?php
                }
                ?>
            ...
            <div class="header">
              <h4 class="title">
                ...
                if (isset($_POST['get'])) {
                  ...
                  echo "<h3><b>Date :</b>".$date."</h3>";
                  $query="SELECT * FROM movie_hall,movie,hall WHERE movie_hall.movie_id=movie.mid and movie_hall.hall_id=hall.h_id and movie_hall.date='$date' and hall_id='$hall' ORDER BY ma_id DESC ";
                  $result=mysqli_query($con,$query);
                //echo mysqli_error();
                  if(mysqli_num_rows($result)>0){
                    ...
                    while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
                      ...
                      echo "<h3><b>Movie :</b>".$row['movie_name']."</h3>";
                      echo "<h3>".$row['hall_name']."</h3>";
                      echo "<h3><b>Total Seat :</b>".$row['seat']."</h3>";

                      $sql="SELECT COUNT(bid) FROM booking where date='$date' and movie='".$row['movie_id']."'";

                      $result1=mysqli_query($con,$sql);
                      $booked=mysqli_num_rows($result1);

                      echo "<h3><b>Booked Seat :</b>".$booked."</h3>";
                      $empty_seat=$row['seat']-$booked;
                       echo "<h3><b>Empty Seat :</b>".$empty_seat."</h3>";
